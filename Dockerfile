...
RUN git clone https://github.com/LineageOS/android_prebuilts_gcc_linux-x86_aarch64_aarch64-linux-android-4.9.git \
    ...
    rm -rf /compiler/aarch64-linux-android-4.9/.git /compiler/clang/.git
...
ENV PATH="/compiler/clang/python3/bin:/compiler/clang/bin:/compiler/aarch64-linux-android-4.9/bin:${PATH}" \
    CCACHE_DIR="/ccache" \
    CCACHE_MAXSIZE="50G" \
    CCACHE_COMPRESS="1"
